...
feature_importance_comparison_all <- read.csv("/work/hs325/World_Corals/machine_learning/all_mets/featureimportance_allmets.csv")
```
...
```{r}
# temp_feature_df <- feature_importance_comparison_coralonly %>%
...
merged_df_rf_all <- merged_df_all %>%
  arrange(desc(RandomForest_Importance))

top100_all <- merged_df_rf_all[1:100, ]
