...
```{r}
#| label: levene_evenness_Scleractinia_family
...
```{r}
#| label: levene_evenness_Scleractinia_symbiont_potential 
...
```{r}
#| label: levene_evenness_Scleractinia_bleaching
...
```{r}
#| label: levene_evenness_Scleractinia_location
...
rect.hclust(cluster.average, k = 10, lwd = 2)
```
